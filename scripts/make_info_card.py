...
# ===========================================================================
HOST = "lunaric"   # shown as  lunaric@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Security researcher · bug bounty"),
    ("kv", "Also", "Web dev · student"),
    ("kv", "Based", "Germany"),
    ("kv", "Speaks", "DE · EN · NL · RU"),
    ("gap",),
    ("sec", "Bug Bounty"),
    ("kv", "HackerOne", "@lunaric11 · signal 7.0 (99th)"),
    ("kv", "YesWeHack", "impact 11.5 · Dojo L1"),
    ("kv", "Finds", "access-ctrl · path-traversal · logic"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "27 rep on HackerOne, 5 thanks received"),
    ("bul", "Resolved reports on Gogo VDP & Cognition"),
    ("bul", "Open for employment"),
]
